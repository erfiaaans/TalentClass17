...
function CardItem({ menu, index, addToCart }) {
    // Modal images
    ...
    useEffect(() => {
        ...
        if (modal) {
            ...
            const handleModalHidden = () => {
                ...
                if (triggerButton) {
                    triggerButton.focus(); // Kembalikan fokus ke tombol pemicu
                }
            };
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h1 className="modal-title fs-5" id="exampleModalLabel">{menu.nama_menu}</h1>
